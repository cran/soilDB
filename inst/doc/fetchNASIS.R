...
# 
# # TODO: this is not technically an alias, it is a calculated value that combines texcl and lieutex
# aliases <- c(texture_class = "phorizon.texcl")
...
# 
# # custom calculated
# # - texture class (texcl, but in lieu of texcl uses lieutex)
...
# # x/y (calculated long/lat), surface_fgravel (replaced by surface_fine_gravel)
