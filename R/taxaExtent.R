...
#' 
#' @param type query type: `taxon`, `formative element`, `mineralogy class`
#' 
...
#' 
#' @details See the [Geographic Extent of Soil Taxa](https://ncss-tech.github.io/AQP/soilDB/taxa-extent.html) tutorial for more detailed examples. The [Keys to Soil Taxonomy](https://www.nrcs.usda.gov/sites/default/files/2022-09/Keys-to-Soil-Taxonomy.pdf) is the authoritative resource for definitions of taxa, formative elements, and family mineralogy classes.
#' 
#' ## Taxon Queries
#' 
...
taxaExtent <- function(x, 
  ...
  # form URL based on query type: taxon, formative element, mineralogy class
  if(type == 'taxon') {
